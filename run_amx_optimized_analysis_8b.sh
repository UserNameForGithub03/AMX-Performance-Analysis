...
OUTPUT_DIR="/data/wangjiaqi/amx_optimized_analysis_qwen3-8b_$(date +%Y%m%d_%H%M%S)"
...
run_amx_optimized_analysis() {
    echo "=========================================="
    echo "AMX-Optimized Model Inference Analysis (Qwen3-8B)"
    echo "=========================================="
